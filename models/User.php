...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public static function findIdentityByAccessToken($token, $type = null)
    {
        ...
        {
            return static::findByUsername('thuc');
        }
        return null;
    }
    ...
    public static function AuthenticateCode($authCode)
    {
        ...
        Yii::info('Get token raw response: '.$raw_response,'thuc');
        ...
        {
            \Yii::error('Get Token error: '.$response["error"],'thuc');
            return false;
        }
        ...
        $raw_response = curl_exec($ch);
        \Yii::info('Raw response: '.$raw_response,'thuc');
        if ( $raw_response == false )
        {
            \Yii::info('Raw response is false','thuc');
            return false;
        }
        ...
        {
            \Yii::error('Token info error: '.$person["error"],'thuc');
            return false;
        }
        ...
        \Yii::info('Email: '.$firstEmail,'thuc');
